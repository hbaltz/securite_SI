    ...
    <?php if($articles->num_rows() > 0): ?>
        ...
        <?php foreach($articles->result() as $article): ?>
            ...
            <article class="clearfix">
                ...
                <p><?php echo character_limiter($article->contenu, 450); ?> <a href="<?php echo base_url($article->cslug) . '/' . $article->aslug; ?>">[More]</a></p>
                    <div class="post-summary-footer">
                        <ul class="post-data-3">
                            ...
                            <li><i class="icon-user"></i> <a href="#"><?php echo $article->username; ?></a></li>
                            <li><i class="icon-comment"></i> <a href="#">5 Comments</a></li>
                            <li><i class="icon-tags"></i> <a href="<?php echo base_url($article->cslug); ?>"><?php echo $article->ctitre; ?></a></li>
                        </ul>
                    </div>
            </article>
